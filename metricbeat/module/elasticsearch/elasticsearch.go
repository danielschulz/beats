...
var (
	...
	CCRStatsAPIAvailableVersion = common.MustNewVersion("1.0.0")

	// EnrichStatsAPIAvailableVersion is the version of Elasticsearch since when the Enrich stats API is available.
	EnrichStatsAPIAvailableVersion = common.MustNewVersion("1.0.0")
	...
	ExpandWildcardsHiddenAvailableVersion = common.MustNewVersion("1.0.0")
